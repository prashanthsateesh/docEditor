            ...
            blocks: [
              ...
              },
              {
                ...
                inlines: [
                  ...
                  { characterFormat: {}, text: "throughout their market base." }
                ]
              },
              {
                paragraphFormat: {
                      ...
                      },
                      {
                        blocks: [
                          ...
                          },
                          {
                            ...
                            characterFormat: {},
                            inlines: [{ characterFormat: {}, text: "Size: 38" }]
                          },
                          {
                            paragraphFormat: {
                              textAlignment: "Center",
                    ...
                    cells: [
                      {
                        blocks: [
                          ...
                          },
                          {
                            ...
                            characterFormat: {},
                            inlines: [{ characterFormat: {}, text: "Size: 35" }]
                          },
                          {
                            paragraphFormat: {
                              textAlignment: "Center",
                        ...
                        blocks: [
                          {
                            ...
                            inlines: [{ characterFormat: {}, text: "Road-150" }]
                          },
                          {
                            paragraphFormat: {
                              textAlignment: "Center",
                          ...
                          },
                          {
                            ...
                            characterFormat: {},
                            inlines: [{ characterFormat: {}, text: "Size: 44" }]
                          },
                          {
                            paragraphFormat: {
                              textAlignment: "Center",
